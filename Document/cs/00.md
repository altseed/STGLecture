...
申し訳ございませんが、現在、Macの講座は記述中です。一部、VisualStudioやWindowsであることを前提とした文章があります。
...
「DirectX エンド ユーザー ランタイム Web インストーラ」をダウンロードします。こちらは、AC-Engineを使用したゲームを動作させるのに必要となります。
