...
[プロジェクト(Mac)](Projects/STG03_Mac.zip?raw=true)
...
Listの中に、生成された弾のインスタンスを入れて、毎回AC-Engineを更新するごとに、Listの中にある弾の座標を動かしていきます。
...
しかし、ソースコードがどんどん長くなっており、段々わかりにくくなってきています。そこで次章では、C#の機能を使ってソースコードを整理していきます。
